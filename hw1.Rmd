...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Charles Yang** and I am a double major in *Software Engineering* and *Data Science*. I am in the ISUCF'V'MB Color Guard, and I like to rock climb.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A data analyst is the most obvious position that is related to data science. The skills required include pulling data from databases, visualizing data, and reporting conclusions.
    [Source/Link](https://blog.udacity.com/2018/01/4-types-data-science-jobs.html)
    ![](https://academy.vertabelo.com/blog/how-to-become-a-data-analyst/How-to-Become-a-Data-Analyst_hu5cf6d2fae9993b23146dfd2adc166044_197627_980x400_fill_box_center_2.png)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am interested in a variety of topics. These include medical research, video game analytics, and sociology. However, considering our most contemporary affairs, I find myself most interested in crime data. [Police Violence Dataset](https://github.com/washingtonpost/data-police-shootings)
